...

{
    ...
    protected void ImageData()
    {
        ...
        con.Open();
        da = new SqlDataAdapter("select * from CategoryProducts", con);
        ds = new DataSet();
        da.Fill(ds);
    ...
    protected void gvImage_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        con = new SqlConnection(connStr);
        string path = "~/Images/CategoryProducts/";
        ...
        SqlCommand cmd = new SqlCommand("update CategoryProducts set catid='" + id.Text + "',productname='" + name.Text + "',productimgurl='" + path + "',description='" + desc.Text.Trim() + "',price='" + price.Text + "' where Productid= "+ prodId + "", con);
    ...
    protected void gvImage_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        con = new SqlConnection(connStr);
        con.Open();
        SqlCommand cmd = new SqlCommand("delete FROM CategoryProducts where Productid='" + Convert.ToInt32(GridView1.DataKeys[e.RowIndex].Value.ToString()) + "'", con);
        cmd.ExecuteNonQuery();
        con.Close();
    ...
    protected void ImageDeleteFromFolder(string imagename)
    {
        ...
        string path = Server.MapPath(@"~/Images/CategoryProducts/" + imagename);
