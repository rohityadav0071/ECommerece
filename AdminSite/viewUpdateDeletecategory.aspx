<%@ Page Title="" Language="C#" MasterPageFile="~/Adminsite/AdminMasterPage.master" AutoEventWireup="true" CodeFile="viewUpdateDeletecategory.aspx.cs" Inherits="adminsite_viewcategory" %>
...
<asp:GridView ID="GridView1" runat="server" 
        ...
        OnRowCancelingEdit="gvImage_RowCancelingEdit" DataKeyNames="catid" CellPadding="4"  
        ...
        <Columns>
            <asp:TemplateField HeaderText="catid" HeaderStyle-Width="150px">
                <EditItemTemplate>
                    <asp:TextBox ID="lblcatid" runat="server" Text='<%# Eval("catid") %>'/>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="category name" HeaderStyle-Width="150px">
                <EditItemTemplate>
                    <asp:TextBox ID="txtname" runat="server" Text='<%# Eval("catname") %>'/>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="category image" HeaderStyle-Width="150px">
                <EditItemTemplate>
                    <asp:Image ID="Image1" runat="server" 
                        ImageUrl='<%# Eval("catimg") %>' Height="80px" Width="100px" />
                    <asp:FileUpload ID="FileUpload1" runat="server" />
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("catimg") %>' Height="80px" Width="100px"/>
                </ItemTemplate>
            </asp:TemplateField>

            <asp:TemplateField HeaderText="Description" HeaderStyle-Width="150px">
                <EditItemTemplate>
                    <asp:TextBox ID="txtDesc" runat="server" Text='<%# Eval("catdesc") %>'/>
                </EditItemTemplate>
                <ItemTemplate>
